...
exports.Meeting = exports.UserRelationship = exports.CartItem = exports.Deal = exports.User = exports.Cart = exports.Product = void 0;
...
CartItem_1.default.belongsTo(Cart_1.default, { foreignKey: "cart_id" });
// קשר One-to-Many בין Product ל-CartItem
Product_1.default.hasMany(CartItem_1.default, { foreignKey: "product_id" });
CartItem_1.default.belongsTo(Product_1.default, { foreignKey: "product_id" });
...
Meeting_1.default.belongsTo(User_1.default, { foreignKey: "customer_id" });
Meeting_1.default.belongsTo(User_1.default, { foreignKey: "agent_id" });
