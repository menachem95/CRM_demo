...
Meeting.belongsTo(User, { foreignKey: "customer_id" });
Meeting.belongsTo(User, { foreignKey: "agent_id" });

export { Product, Cart, User, Deal, CartItem, UserRelationship, Meeting };
